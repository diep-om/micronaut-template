...
insert into `office`(`office_code`, `city`, `phone`, `address_line_first`, `address_line_second`,
                     `state`, `country`, `postal_code`, `territory`, `internal_budget`)
values ('1', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA',
        'AZ934VB', 'NA', 90000),

       ('2', 'Boston', '+1 215 837 0825', '1550 Court Place', 'Suite 102', 'MA', 'USA', 'XX021SS',
        'NA', 85000),

       ('3', 'NYC', '+1 212 555 3000', '523 East 53rd Street', 'apt. 5A', 'NY', 'USA', 'AA100CV',
        'NA', 100000),

       ('4', 'Paris', '+33 14 723 4404', '43 Rue Jouffroy D''abbans', NULL, NULL, 'France',
        'MN750CV', 'EMEA', 35000),

       ('5', 'Tokyo', '+81 33 224 5000', '4-1 Kioicho', NULL, 'Chiyoda-Ku', 'Japan', 'RT102TT',
        'Japan', 90000),

       ('6', 'Sydney', '+61 2 9264 2451', '5-11 Wentworth Avenue', 'Floor --2', NULL, 'Australia',
        'XC344VD', 'APAC', 45500),

       ('7', 'London', '+44 20 7877 2041', '25 Old Broad Street', 'Level 7', 'N/A', 'UK', 'CV555RR',
        'EMEA', 50000),

       ('8', NULL, '+44 20 1827 21411', '25 Hum Street', 'Level 2', NULL, 'USA', 'CV556RR', 'EMEA',
        95000),

       ('9', 'Bucharest', '+44 20 1827 21411', '22 DN1', 'Level 12', NULL, '', 'CV557RR', 'NA',
        120000),
       ...
       ('12', 'Tokyo', '+81 33 224 3444', '4-2 Kioicho', NULL, 'Koil-Ku', 'Japan', 'DD578YU',
        'Japan', 55000),

       ('13', 'Los Angeles', '+3 223 7995', '110 Only Street', 'Alio 0', 'CA', 'USA', 'AZ944VB',
        'NA', 40000),

       ('14', 'San Diego', '+1 222 4345 5553', '220 Ternary Street', 'Alio 73', 'CA', 'USA',
        'AZ948VB', 'NA', 65000),

       ('15', 'Springfield', '+1 0009 9000 777', '155 Market Place', 'Suite 107', 'MA', 'USA',
        'XX521SS', 'NA', 55000)
ON DUPLICATE KEY UPDATE `office_code`=`office_code`;

/* Data for the table `department` */

insert into `department`(`department_id`, `name`, `phone`, `code`, `office_code`, `topic`,
                         `local_budget`, `profit`, `forecast_profit`, `cash`, `accounts_receivable`,
                         `inventories`, `accounts_payable`, `st_borrowing`, `accrued_liabilities`)
values ('1', 'Advertising', '-int 4782', '1333', '1', 'publicity, promotion', NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL, NULL),

       ('2', 'Sales', '-int 41233', '1441', '1', 'commerce, trade, sellout, transaction', 650000,
        900000, 800000, 20000, NULL, 10000, NULL, NULL, NULL),

       ('3', 'Accounting', '-int 8233', '2311', '2', 'monetary, business', NULL, 450000, NULL,
        25000, NULL, NULL, NULL, NULL, NULL),

       ('4', 'Finance', '-int 4421', '3229', '3', 'commerce, fiscal, monetary, business', 120000,
        90000, NULL, NULL, NULL, NULL, 40000, 10000, NULL),

       ('5', 'Sales', '-int 34443', '6554', '2', 'commerce, sellout, transaction', 345000, 350000,
        450000, 11000, 25000, 5000, 10000, 85000, 12000),

       ('6', 'Sales', '-int 7664', '1234', '4', NULL, NULL, 100000, NULL, NULL, NULL, NULL, 50000,
        NULL, NULL),

       ('7', 'Marketing', '-int 1266', '9090', '4', 'market, research, advertising', NULL, 500000,
        250000, NULL, 11000, NULL, 5000, NULL, 1000),

       ('8', 'Marketing', '-int 4543', '4544', '5', 'market, research, advertising', NULL, 430000,
        900000, NULL, NULL, NULL, NULL, NULL, NULL),

       ('9', 'Assembly', '-int 8777', '5455', '6', 'gathering, construction, joining', 500000,
        500000, 450000, NULL, NULL, NULL, 7000, NULL, NULL),

       ('10', 'Accounting', '-int 6765', '4555', '6', 'monetary, business', NULL, NULL, 100000,
        10000, NULL, NULL, 4000, NULL, NULL),

       ('11', 'Finance', '-int 1111', '7876', '7', 'commerce, fiscal, monetary, business', 450000,
        NULL, 450000, NULL, NULL, NULL, NULL, NULL, NULL),

       ('12', 'Logistics', '-int 4421', '3222', '8', 'facilities, supplies', NULL, 120000, 300000,
        10000, NULL, 11000, NULL, 16000, NULL),

       ('13', 'Logistics', '-int 7453', '7884', '9', 'facilities, supplies', NULL, 80000, 100000,
        9000, NULL, 6000, 2300, 4400, NULL),

       ('14', 'Logistics', '-int 3433', '6777', '12', 'facilities, supplies', 235000, 233000, NULL,
        NULL, NULL, 1000, NULL, NULL, 9000),

       ('15', 'HR', '-int 2323', '7888', '12', 'people, interview, hiring', NULL, 120000, 120000,
        NULL, 544, NULL, NULL, 2300, NULL)
...
values ('1', '1'),
       ...
       ('7', '2')
ON DUPLICATE KEY UPDATE `offices_office_code`=`offices_office_code`;

/* Data for the table `employee` */

insert into `employee`(`employee_number`, `last_name`, `first_name`, `extension`, `email`,
                       `office_code`, `salary`, `commission`, `reports_to`, `job_title`,
                       `employee_of_year`, `monthly_bonus`)
values (1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', 120000, 10000, NULL,
        'President', NULL, '450, 210, 222, 123, 110, 0, 0, 0, 560, 440, 315, 125, 0, 900'),

       (1056, 'Patterson', 'Mary', 'x4611', 'mpatterso@classicmodelcars.com', '1', 100000, 5000,
        1002, 'VP Sales', NULL, NULL),

       (1076, 'Firrelli', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 100000, 3500,
        1002, 'VP Marketing', NULL, '0, 0, 0, 125, 125, 150, 232, 100, 0'),

       (1088, 'Patterson', 'William', 'x4871', 'wpatterson@classicmodelcars.com', '6', 80000, NULL,
        1056, 'Sales Manager (APAC)', NULL, '560, 120, 440, 320, 315, 0, 0, 100, 125, 0, 900'),

       (1102, 'Bondur', 'Gerard', 'x5408', 'gbondur@classicmodelcars.com', '4', 80000, NULL, 1056,
        'Sales Manager (EMEA)', NULL, NULL),

       (1143, 'Bow', 'Anthony', 'x5428', 'abow@classicmodelcars.com', '1', 75000, 5000, 1056,
        'Sales Manager (NA)', NULL, NULL),

       (1165, 'Jennings', 'Leslie', 'x3291', 'ljennings@classicmodelcars.com', '1', 60000, NULL,
        1143, 'Sales Rep', '2003, 2004', NULL),

       (1166, 'Thompson', 'Leslie', 'x4065', 'lthompson@classicmodelcars.com', '1', 60000, NULL,
        1143, 'Sales Rep', '2003, 2005', NULL),

       (1188, 'Firrelli', 'Julie', 'x2173', 'jfirrelli@classicmodelcars.com', '2', 60000, NULL,
        1143, 'Sales Rep', '2004, 2005', NULL),

       (1216, 'Patterson', 'Steve', 'x4334', 'spatterson@classicmodelcars.com', '2', 55000, 1000,
        1143, 'Sales Rep', '2005, 2006', NULL),

       (1286, 'Tseng', 'Foon Yue', 'x2248', 'ftseng@classicmodelcars.com', '3', 55000, 2000, 1143,
        'Sales Rep', '2002, 2003, 2004', NULL),

       (1323, 'Vanauf', 'George', 'x4102', 'gvanauf@classicmodelcars.com', '3', 55000, 1500, 1143,
        'Sales Rep', '2000, 2001, 2005', NULL),

       (1337, 'Bondur', 'Loui', 'x6493', 'lbondur@classicmodelcars.com', '4', 60000, NULL, 1102,
        'Sales Rep', '2004, 2007', NULL),

       (1370, 'Hernandez', 'Gerard', 'x2028', 'ghernande@classicmodelcars.com', '4', 65000, NULL,
        1102, 'Sales Rep', '2000, 2001', NULL),

       (1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '4', 55000, NULL,
        1102, 'Sales Rep', '2000, 2001, 2003, 2005', NULL),

       (1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '7', 50000, 1000, 1102,
        'Sales Rep', '2004, 2008', NULL),

       (1504, 'Jones', 'Barry', 'x102', 'bjones@classicmodelcars.com', '7', 50000, 500, 1102,
        'Sales Rep', '2002, 2003, 2005', NULL),

       (1611, 'Fixter', 'Andy', 'x101', 'afixter@classicmodelcars.com', '6', 50000, 1000, 1088,
        'Sales Rep', '2002, 2005', NULL),

       (1612, 'Marsh', 'Peter', 'x102', 'pmarsh@classicmodelcars.com', '6', 55000, NULL, 1088,
        'Sales Rep', '2003, 2005, 2006, 2007', NULL),

       (1619, 'King', 'Tom', 'x103', 'tking@classicmodelcars.com', '6', 60000, 1000, 1088,
        'Sales Rep', '2002, 2004', NULL),

       (1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '5', 55000, 2000, 1056,
        'Sales Rep', '2003, 2005', NULL),

       (1625, 'Kato', 'Yoshimi', 'x102', 'ykato@classicmodelcars.com', '5', 60000, 2500, 1621,
        'Sales Rep', '2004, 2005, 2006', NULL),

       (1702, 'Gerard', 'Martin', 'x2312', 'mgerard@classicmodelcars.com', '4', 50000, 3400, 1102,
        'Sales Rep', '2005, 2007', NULL)
ON DUPLICATE KEY UPDATE `employee_number`=`employee_number`;

/* Data for the table `customer` */

insert into `customer`(`customer_number`, `customer_name`, `contact_last_name`,
                       `contact_first_name`, `phone`, `sales_rep_employee_number`, `credit_limit`,
                       `first_buy_date`)
values (99, 'Australian Home', 'Paoule', 'Sart ', '40.11.2555', 1370, '21000.00', 20210),
       ...
       (202, 'Canadian Gift Exchange Network', 'Tamuri', 'Yoshi ', '(604) 555-3392', 1323,
        '90300.00', 20908),
       ...
       (233, 'Québec Home Shopping Network', 'Fresnière', 'Jean ', '(514) 555-8054', 1286,
        '48700.00', 20012),
       ...
       (259, 'Toms Spezialitäten, Ltd', 'Pfalzheim', 'Henriette ', '0221-5554327', 1504,
        '120400.00', 20104),

       (260, 'Royal Canadian Collectables, Ltd.', 'Lincoln', 'Elizabeth ', '(604) 555-4555', 1323,
        '89600.00', 20165),
       ...
       (484, 'Iberia Gift Imports, Corp.', 'Roel', 'José Pedro ', '(95) 555 82 82', 1702,
        '65700.00', 20154),
       ...
       (489, 'Double Decker Gift Stores, Ltd', 'Smith', 'Thomas ', '(171) 555-7555', 1501,
        '43300.00', 20103),
...
ON DUPLICATE KEY UPDATE `customer_number`=`customer_number`;

/* Data for the table `customerdetail` */

insert into `customerdetail`(`customer_number`, `address_line_first`, `address_line_second`, `city`,
...
values (99, '43 Rue 2', NULL, 'Paris', NULL, '25017', 'France'),
       ...
       (385, '15 McCallum Street', 'NatWest Center #13-03', 'Makati City', NULL, '1227 MM',
        'Philippines'),
...
insert into `productline`(`product_line`, `code`, `text_description`, `html_description`, `image`)
values ('Classic Cars', 599302,
       ...
       ('Vintage Cars', 223113,
        ...
        NULL, NULL)
ON DUPLICATE KEY UPDATE `product_line`=`product_line`;
...
insert into `product`(`product_id`, `product_name`, `product_line`, `code`, `product_scale`,
                      `product_vendor`, `product_description`, `quantity_in_stock`, `buy_price`,
                      `msrp`)
values (1, '1969 Harley Davidson Ultimate Chopper', 'Motorcycles', 599302, '1:10',
        'Min Lin Diecast', 'PENDING', 7933, '48.81', '95.70'),

       (2, '1952 Alpine Renault 1300', 'Classic Cars', 599302, '1:10', 'Classic Metal Creations',
        'PENDING', 7305, '98.58', '214.30'),

       (3, '1996 Moto Guzzi 1100i', 'Motorcycles', 599302, '1:10', 'Highway 66 Mini Classics',
        'PENDING', 6625, '68.99', '118.94'),

       (4, '2003 Harley-Davidson Eagle Drag Bike', 'Motorcycles', 599302, '1:10',
        'Red Start Diecast', 'PENDING', 5582, '91.02', '193.66'),

       (5, '1972 Alfa Romeo GTA', 'Classic Cars', 599302, '1:10', 'Motor City Art Classics',
        'PENDING', 3252, '85.68', '136.00'),

       (6, '1962 LanciaA Delta 16V', 'Classic Cars', 599302, '1:10', 'Welly Diecast Productions',
        'PENDING', 6791, '103.42', '147.74'),
       ...
       (19, '1937 Lincoln Berline', 'Vintage Cars', 223113, '1:18', 'Motor City Art Classics',
        'Features opening engine cover, doors, trunk, and fuel filler cap. Color black', 8693,
        '60.62', '102.74'),

       (20, '1936 Mercedes-Benz 500K Special Roadster', 'Vintage Cars', 223113, '1:18',
        'Studio M Art Models',
       ...
       (26, '1998 Chrysler Plymouth Prowler', 'Classic Cars', 599302, '1:18',
       ...
       (28, '1964 Mercedes Tour Bus', 'Trucks and Buses', 569331, '1:18', 'Unimax Art Galleries',
        'Exact replica. 100+ parts. working steering system, original logos', 8258, '74.86',
        '122.73'),
       ...
       (32, '1936 Harley Davidson El Knucklehead', 'Motorcycles', 599302, '1:18',
       ...
       (35, '1913 Ford Model T Speedster', 'Vintage Cars', 223113, '1:18',
       ...
       (38, '18th Century Vintage Horse Carriage', 'Vintage Cars', 223113, '1:18',
        'Red Start Diecast',
       ...
       (46, '1948 Porsche Type 356 Roadster', 'Classic Cars', 599302, '1:18',
        'Gearbox Collectibles',
       ...
       (48, '1941 Chevrolet Special Deluxe Cabriolet', 'Vintage Cars', 223113, '1:18',
        'Exoto Designs',
       ...
       (57, '1970 Dodge Coronet', 'Classic Cars', 599302, '1:24', 'Highway 66 Mini Classics',
        '1:24 scale die-cast about 18" long doors open, hood opens and rubber wheels', 4074,
        '32.37', '57.80'),

       (58, '1997 BMW R 1100 S', 'Motorcycles', 599302, '1:24', 'Autoart Studio Design',
        'Detailed scale replica with working suspension and constructed from over 70 parts', 7003,
        '60.86', '112.70'),
       ...
       (61, '1939 Chevrolet Deluxe Coupe', 'Vintage Cars', 223113, '1:24',
       ...
       (62, '1960 BSA Gold Star DBD34', 'Motorcycles', 599302, '1:24', 'Highway 66 Mini Classics',
        'Detailed scale replica with working suspension and constructed from over 70 parts', 15,
        '37.32', '76.17'),
       ...
       (64, '1938 Cadillac V-16 Presidential Limousine', 'Vintage Cars', 223113, '1:24',
       ...
       (68, '1958 Chevy Corvette Limited Edition', 'Classic Cars', 599302, '1:24',
        'Carousel DieCast Legends',
       ...
       (74, '1971 Alpine Renault 1600s', 'Classic Cars', 599302, '1:24',
        'Welly Diecast Productions',
       ...
       (79, 'Corsair F4U ( Bird Cage)', 'Planes', 433823, '1:24', 'Second Gear Diecast',
        'Has retractable wheels and comes with a stand. Official logos and insignias.', 6812,
        '29.34', '68.24'),
       ...
       (82, '1936 Chrysler Airflow', 'Vintage Cars', 223113, '1:24', 'Second Gear Diecast',
        'Features opening trunk,  working steering system. Color dark green.', 4710, '57.46',
        '97.39'),
       ...
       (85, '1980’s GM Manhattan Express', 'Trucks and Buses', 569331, '1:32',
        'Motor City Art Classics',
       ...
       (86, '1997 BMW F650 ST', 'Motorcycles', 599302, '1:32', 'Exoto Designs',
        'Features official die-struck logos and baked enamel finish. Comes with stand.', 178,
        '66.92', '99.89'),
       ...
       (88, '1954 Greyhound Scenicruiser', 'Trucks and Buses', 569331, '1:32',
        'Classic Metal Creations',
        'Model features bi-level seating, 50 windows, skylights & glare resistant glass, working steering system, original logos',
        2874, '25.98', '54.11'),

       (89, '1950''s Chicago Surface Lines Streetcar', 'Trains', 123333, '1:32',
        'Gearbox Collectibles',
       ...
       (90, '1996 Peterbilt 379 Stake Bed with Outrigger', 'Trucks and Buses', 569331, '1:32',
        'Red Start Diecast',
       ...
       (94, 'Diamond T620 Semi-Skirted Tanker', 'Trucks and Buses', 569331, '1:50',
       ...
       (98, 'American Airlines: B767-300', 'Planes', 433823, '1:700', 'Min Lin Diecast',
        'Exact replia with official logos and insignias and retractable wheels', 5841, '51.15',
        '91.34'),
       ...
       (101, 'America West Airlines B757-200', 'Planes', 433823, '1:700', 'Motor City Art Classics',
        'Official logos and insignias. Working steering system. Rotating jet engines', 9653,
        '68.80', '99.72'),
       ...
       (103, '1982 Camaro Z28', 'Classic Cars', 599302, '1:18', 'Carousel DieCast Legends',
        'Features include opening and closing doors. Color: White. rnMeasures approximately 9 1/2" Long.',
        6934, '46.53', '101.15'),

       (104, 'ATA: B757-300', 'Planes', 433823, '1:700', 'Highway 66 Mini Classics',
        'Exact replia with official logos and insignias and retractable wheels', 7106, '59.33',
        '118.65'),
...
insert into `order`(`order_id`, `order_date`, `required_date`, `shipped_date`, `status`, `comments`,
...
values (10100, '2003-01-06', '2003-01-13', '2003-01-10', 'Shipped', NULL, 363, 301.84),
       ...
       (10165, '2003-10-22', '2003-10-31', '2003-12-26', 'Shipped',
        'This order was on hold because customers credit limit had been exceeded. Order will ship when payment is received',
        148, 1674.66),
       ...
       (10178, '2003-11-08', '2003-11-16', '2003-11-10', 'Shipped',
        'Custom shipping instructions sent to warehouse', 242, 989.95),
       ...
       (10206, '2003-12-05', '2003-12-13', '2003-12-08', 'Shipped', 'Can we renegotiate this one?',
        202, 1065.55),
       ...
       (10270, '2004-07-19', '2004-07-27', '2004-07-24', 'Shipped', 'Can we renegotiate this one?',
        282, 1088.2),
       ...
       (10284, '2004-08-21', '2004-08-29', '2004-08-26', 'Shipped',
        'Custom shipping instructions sent to warehouse', 299, 985.48),
       ...
       (10382, '2005-02-17', '2005-02-23', '2005-02-18', 'Shipped',
        'Custom shipping instructions sent to warehouse', 124, 1426.01),
       ...
       (10386, '2005-03-01', '2005-03-09', '2005-03-06', 'Resolved',
        'Disputed then Resolved on 3/15/2005. Customer does not like the craftsmaship of the models.',
        141, 1352.06),
       ...
       (10421, '2005-05-29', '2005-06-06', NULL, 'In Process',
        'Custom shipping instructions were sent to warehouse', 124, 211.86),
...
insert into `orderdetail`(`order_id`, `product_id`, `quantity_ordered`, `price_each`,
                          `order_line_number`)
values (10100, 23, 30, '136.00', 3),
       ...
       (10425, 94, 18, '94.92', 2)
ON DUPLICATE KEY UPDATE `orderdetail_id`=`orderdetail_id`;

/* Data for the table `payment` */

insert into `payment`(`customer_number`, `check_number`, `payment_date`, `invoice_amount`,
                      `caching_date`)
...
insert into `bank_transaction`(`transaction_id`, `bank_name`, `bank_iban`, `transfer_amount`,
                               `customer_number`, `check_number`, `caching_date`, `card_type`,
                               `status`)
values (1, 'Bank Ltd. US', 'DN44398834N34', '6631.36', 447, 'AO757239', '2003-09-15 18:22:54',
        'VisaElectron', 'SUCCESS'),

       (2, 'Bank Ltd. US', '348398H3493HG93', '26304.13', 447, 'OU516561', '2004-12-17 16:45:22',
        'VisaElectron', 'FAILED'),

       (3, 'Transilvania Bank', '8TVN598N454VN84T', '9977.85', 462, 'GC60330',
        '2003-11-08 18:57:25', 'VisaElectron', 'SUCCESS'),
       ...
       (10, '5 Stars Bank', '8VN8UNT5U45T8', '3382.13', 462, 'GC60330', '2004-07-01 12:31:56',
        'VisaElectron', 'SUCCESS'),

       (11, '5 Stars Bank', '8VN8UNT5U45T8', '2566.17', 462, 'GC60330', '2004-07-03 11:21:16',
        'VisaElectron', 'SUCCESS'),

       (12, 'Bank Ltd. US', '348398H3493HG93', '12304.13', 447, 'OU516561', '2004-12-27 16:15:22',
        'VisaElectron', 'SUCCESS'),

       (13, 'BRT Bank', 'TVNU343T38TUNU3T', '52151.81', 278, 'GP636783', '2003-03-02 12:32:00',
        'MasterCard', 'FAILED'),

       (14, 'Optimus Bank', 'GH390439i344F', '56321.33', 124, 'AE215433', '2005-03-05 12:32:56',
        'VisaElectron', 'SUCCESS'),

       (15, 'Optimus Bank', 'GH390439i344F', '9866.21', 124, 'AE215433', '2005-03-05 13:00:00',
        'VisaElectron', 'SUCCESS'),

       (16, 'Optimus Bank', 'GH390439i344F', '35057.05', 124, 'AE215433', '2005-03-05 14:12:00',
        'VisaElectron', 'SUCCESS'),

       (17, '5 Stars Bank', 'QQQ333330944', '6522.99', 141, 'IN446258', '2005-03-25 13:44:11',
        'VisaElectron', 'SUCCESS'),

       (18, '5 Stars Bank', 'QQQ333330944', '2566.17', 141, 'IN446258', '2005-03-25 14:00:05',
        'VisaElectron', 'SUCCESS'),

       (19, '5 Stars Bank', 'QQQ333330944', '15800.30', 141, 'IN446258', '2005-03-25 14:03:05',
        'VisaElectron', 'SUCCESS'),

       (20, '5 Stars Bank', 'QQQ333330944', '21455.32', 141, 'IN446258', '2005-03-25 15:13:05',
        'VisaElectron', 'SUCCESS'),

       (21, '5 Stars Bank', 'QQQ333330944', '9883.22', 141, 'IN446258', '2005-03-25 15:25:05',
        'VisaElectron', 'SUCCESS'),

       (22, '5 Stars Bank', 'QQQ333330944', '8843.26', 141, 'IN446258', '2005-03-25 16:00:05',
        'VisaElectron', 'SUCCESS')
ON DUPLICATE KEY UPDATE `transaction_id`=`transaction_id`;

/* Data for the table `sale` */

insert into `sale`(`sale_id`, `fiscal_year`, `sale`, `employee_number`, `fiscal_month`,
...
insert into `employee_status`(`id`, `employee_number`, `status`, `acquired_date`)
values (1, 1002, 'REGULAR', '2004-04-14'),
...
ON DUPLICATE KEY UPDATE `day_id`=`day_id`;
...
values ('Paris', 'Los Angeles', 9080),
       ...
       ('Tokyo', 'London', 9559)
ON DUPLICATE KEY UPDATE `depart_town`=`depart_town`;